...
export const vi = {
  ...
  rules: {
    ...
    waitProctorOpen:
      'Giám thị cần bấm «Mở đề» cho môn thi trên màn hình giám sát trước khi bạn bắt đầu làm bài.',
  },
  confirmInfo: {
    title: 'XÁC NHẬN THÔNG TIN THÍ SINH',
    lead: 'Kiểm tra kỹ thông tin dưới đây trước khi vào phòng thi',
    wrongHint: 'Nếu thông tin không đúng, bấm Đăng xuất và liên hệ giám thị để được hỗ trợ.',
    confirm: 'XÁC NHẬN',
    logout: 'ĐĂNG XUẤT',
  ...
  exam: {
    ...
    emptyQuestions: 'Đề thi chưa có câu hỏi. Liên hệ giám thị để kiểm tra gói đề đã import.',
    renderError: 'Không hiển thị được đề thi. Thử tải lại trang hoặc gọi giám thị.',
    submit: 'NỘP BÀI',
    ...
    markQuestion: 'Đánh dấu',
    unmarkQuestion: 'Bỏ đánh dấu',
    marked: 'Đã đánh dấu',
    zoomIn: 'Phóng to',
    zoomOut: 'Thu nhỏ',
