...
|---------------------|----------------|
| Cấu hình ca (cùng packageId) | `powershell -File scripts\setup-native.ps1` |
...
- [ ] Đến khung giờ môn tiếp theo: cắm USB môn đó → import (nếu chưa) → mở đề
...
| Import lỗi | Dry-run ZIP trên CBT - Viewer |
